...
//!
//! ERC-4626 compliant tokenized vault with time-interpolated yield distribution.
//! Instead of yield appearing as a discrete jump, total assets increase linearly
//! between distribution checkpoints. Share price appreciates smoothly over time.
//!
//! Key features:
//! - Streaming yield via linear interpolation (Sablier-style)
...
//! - Permissionless checkpoint crank
...
declare_id!("SVS5StreamYie1dVau1tXXXXXXXXXXXXXXXXXXXXXXXXX");
...
pub mod svs_5 {
    ...
    /// Deposit assets and receive shares at current streaming price
    ...
    /// Mint exact shares by depositing required assets at current streaming price
    ...
    /// Withdraw exact assets by burning required shares at current streaming price
    ...
    /// Redeem shares for assets at current streaming price
