//! Redeem instruction: withdraw from confidential balance at streaming price, burn exact shares, transfer assets.
...
pub fn handler(
    ...
    // Use streaming total_assets for share price calculation
    ...
    // Update vault's tracked total_shares and base_assets
